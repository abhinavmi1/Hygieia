...
public class InjectedTest extends junit.framework.TestCase {
  public static junit.framework.Test suite() throws Exception {
    ...
    parameters.put("basedir","C:\\Program Files (x86)\\Jenkins\\workspace\\HygieiaMasterBuild\\hygieia-jenkins-plugin");
    parameters.put("artifactId","hygieia-publisher");
    parameters.put("outputDirectory","C:\\Program Files (x86)\\Jenkins\\workspace\\HygieiaMasterBuild\\hygieia-jenkins-plugin\\target\\classes");
    parameters.put("testOutputDirectory","C:\\Program Files (x86)\\Jenkins\\workspace\\HygieiaMasterBuild\\hygieia-jenkins-plugin\\target\\test-classes");
